...
import { Head, Link, apiRequests, useAppPage } from '../../uiHelpers';
...
export default function Dashboard({ products, users, recentMovements, stats }) {
    const { auth, flash, errors } = useAppPage().props;
    ...
    const submitInventory = (productId) => {
        ...
        apiRequests.patch(`/admin/products/${productId}/inventory`, {
    ...
    const submitCatalogUpdate = (productId) => {
        ...
        apiRequests.put(`/admin/products/${productId}`, {
            ...draft,
            stock: Number(draft.stock),
            low_stock_threshold: Number(draft.low_stock_threshold),
        }, {
    ...
    const submitCatalogCreate = (event) => {
        ...
        apiRequests.post('/admin/products', {
            ...createProductDraft,
    ...
    const deleteProduct = (productId, productName) => {
        ...
        apiRequests.delete(`/admin/products/${productId}`, {
            preserveScroll: true,
            onFinish: () => setSubmittingKey(null),
        });
    };
    ...
    const submitAccountCreate = (event) => {
        ...
        apiRequests.post('/admin/accounts', createAccountDraft, {
            preserveScroll: true,
            onFinish: () => setSubmittingKey(null),
        });
    };
    ...
    const submitAccountUpdate = (userId) => {
        ...
        apiRequests.put(`/admin/accounts/${userId}`, draft, {
            preserveScroll: true,
            onFinish: () => setSubmittingKey(null),
        });
    };
    ...
    const deleteAccount = (userId, userName) => {
        ...
        apiRequests.delete(`/admin/accounts/${userId}`, {
            preserveScroll: true,
            onFinish: () => setSubmittingKey(null),
        });
    };
